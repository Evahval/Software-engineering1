...
Scenario: the employee registers hours on an activity that they are assigned
    Given there is an employee "EHA" and a project "project" "2003"
 ...
 Scenario: The employee registers hours on an activity that they are not assigned to
    Given that the activity "activity" is active and a project "project" "2003"
 ...
 Scenario: The employee registers hours on an activity that is not active
    Given that the activity "activity" is not active in a project "project" "2003"
 ...
 Scenario: Employee has 10 or more activities.
    Given there is an employee "EHA" that does not have permission to have more activities and a project "project" "2003"
